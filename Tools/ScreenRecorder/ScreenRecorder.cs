...
/**
 * origin is https://gist.github.com/DashW/74d726293c0d3aeb53f4
 * */

namespace com.ich.Tools.ScreenRecorder.DashW
{
    ...
    public class ScreenRecorder : MonoBehaviour
    {
        ...
        public string outputFrameFileName = "frame";
        ...
        private string GetFileFullName (string index)
        {
            string filename = string.Concat(outputFrameFileName, index, ".bmp");
